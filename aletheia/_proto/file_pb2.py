...
_FILE_CONNECTOR = _descriptor.EnumDescriptor(
  name='Connector',
  full_name='alethaia.File.Connector',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_FILE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='alethaia.File.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='path', full_name='alethaia.File.path', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connector', full_name='alethaia.File.connector', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mime_type', full_name='alethaia.File.mime_type', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_directory', full_name='alethaia.File.is_directory', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='meta', full_name='alethaia.File.meta', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='md5', full_name='alethaia.File.md5', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sha1', full_name='alethaia.File.sha1', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sha256', full_name='alethaia.File.sha256', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='checksum', full_name='alethaia.File.checksum',
...
File = _reflection.GeneratedProtocolMessageType('File', (_message.Message,), {
  'DESCRIPTOR' : _FILE,
  '__module__' : '_proto.file_pb2'
  # @@protoc_insertion_point(class_scope:alethaia.File)
  })
